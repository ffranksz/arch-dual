# Arch Linux and Windows or other system Dualboot Shell Script Install
...
- Esse script roda fora do chroot, assim que bootar a archiso execute esses comandos:
  ...
  ```sh
  loadkeys br-abnt2
  curl https://raw.githubusercontent.com/ffrannksz/arch-dual/main/arch-dual.sh |bash
  ```

  ### Depos entrar no chroot e seguir o [script](https://github.com/ffrannksz/arch-chroot)
